export const en = {
  strings: {
    ...
    'auth.contactTitle': 'What is your phone number?',
    'auth.contactSubtitle': 'No password needed. We will text you a code each time you log in.',
    ...
    'auth.logInSubtitle': 'Enter your phone number and we will text you a code.',
    'auth.useOther': 'Use a different number',
    ...
    'auth.userExists': 'An account with this number already exists. Log in instead.',
